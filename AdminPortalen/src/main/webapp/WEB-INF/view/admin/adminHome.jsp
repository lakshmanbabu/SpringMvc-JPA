                    ...
                    <div class="row">
                           <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-maroon">
                                ...
                                <a href="${contextPath}/admin/viewPostedAd" class="small-box-footer">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                ...
                                <a href="${contextPath}/admin/viewUserDetail" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div>
                         <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-teal">
                                ...
                                <a href="${contextPath}/admin/viewNotifications" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div>
                        ...
                        <section class="col-lg-6 connectedSortable">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body chat" id="chat-box">
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="${contextPath}/resources/img/avatar.png" alt="user image" class="online"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="${contextPath}/resources/img/avatar2.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
                                        <img src="${contextPath}/resources/img/avatar3.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
