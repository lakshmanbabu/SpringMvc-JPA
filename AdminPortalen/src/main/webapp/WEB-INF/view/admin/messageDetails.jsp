                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-8">
                            ...
                            <div class="col-md-9" id="messageView" style=" width: 760px;" >
							<div class="panel panel-default">
								
								<div class="panel-body message">
									
									<a href="${contextPath}/admin/mailBox"><button class="btn btn-default-primary">Back</button></a>&nbsp;&nbsp;
									...
									<span class="btn-group">
										...
										<button class="btn btn-default" onclick="deleteMessage()"><span class="fa fa-trash-o"></span></button>
											
									<div class="message-title" style="margin-top: 15px;">
										<h4 id="messageTitle"> </h4>
									</div>
									<hr style="border: 1px solid #ccc; "/>
									<div class="header" style="margin-top: 14px;">
										<img src="${contextPath}/resources/img/avatar.png" class="avatar" style="width: 50px;">
										
										<span >	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${folders.subject} </span>
										<fmt:formatDate value="${folders.message.sentDateTime}" var="sentDate" type="both"  dateStyle="MEDIUM" />
										<div class="date" align="right"><span class="fa fa-paper-clip"></span>  <b>${sentDate}</b></div>
										...
										<ul>
											<li>
												...
												<span class="quickMenu">
													<a class="fa fa-search" href="page-inbox-message.html#"><i></i></a>
													<a class="fa fa-share" href="page-inbox-message.html#"><i></i></a>
													<a class="fa fa-cloud-download" href="page-inbox-message.html#"><i></i></a>
												</span>
											</li>
											<li>
								...
								<!-- 	<form action="" method="post">
										<div class="form-group">
											<textarea placeholder="Click here to reply" rows="12" name="body" id="message" class="form-control"></textarea>
										</div>
										<div class="form-group">	
											<button class="btn btn-success" type="submit" tabindex="3">Send message</button>
										</div>	
									</form>
									 -->
								</div>	
